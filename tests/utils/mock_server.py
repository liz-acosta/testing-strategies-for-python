...
DOG_BREED_INFO_RESPONSE = {
    "data": {
        ...
        "relationships": {
            "group": {
                "data": {"id": "f56dc4b1-ba1a-4454-8ce2-bd5d41404a0c", "type": "group"}
            }
        },
    },
    "links": {
...
class MockServerRequestHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        """ "Replace the GET request that matches the `/breeds` pattern in the path with the following behaviors"""
